...
the companion plan (`docs/superpowers/plans/2026-08-25-realtime-data-plane-remediation.md`).
**Evidence:** `docs/superpowers/research/2026-08-25-realtime-root-cause-report.md` (why),
