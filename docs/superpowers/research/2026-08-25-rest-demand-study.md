...
**Task:** I8 of `docs/superpowers/plans/2026-08-25-realtime-data-plane-investigation.md`.
...
`docs/superpowers/research/2026-08-25-realtime-live-baseline.md`): background classes held
