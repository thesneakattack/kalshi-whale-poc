# Roadmap archive (frozen snapshot, 2026-08-16)

**This is a frozen copy, not a living document.** `ROADMAP.md` had grown to
1300+ lines — the "Shipped (condensed)" section stopped being condensed
somewhere along the way and accumulated a full session-by-session narrative
for nearly every item ever shipped, plus two large doc-reference bullets
whose "still open" residue had gotten buried under hundreds of lines of
already-done sub-findings. This file preserves that detail verbatim as of
2026-08-16, so `ROADMAP.md` itself could be cut back down to a short,
actually-workable list of what's still open (same cutover `docs/roadmap-
archive-2026-08-09.md` did once already, at 837 lines). Nothing here is
maintained going forward: don't check items off in this file, don't add
new ones. For ongoing work see `ROADMAP.md`; for the continuing
phase-by-phase historical record (including everything shipped after this
snapshot was taken) see `static/status.html` (`/status`), which remains
the actively-maintained backward-looking doc. For anything shipped before
2026-08-09, see `docs/roadmap-archive-2026-08-09.md` instead — this file
only covers the 2026-08-09 → 2026-08-16 window.
