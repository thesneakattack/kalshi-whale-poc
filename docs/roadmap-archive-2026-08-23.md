# Roadmap archive (frozen snapshot, 2026-08-23)

**This is a frozen copy, not a living document.** `ROADMAP.md` had grown to
979 lines — most of it full-narrative detail (evidence, numbers, and
step-by-step fix descriptions) on items already shipped, the same growth
pattern that triggered the two prior cutovers. This file preserves that
detail verbatim as of 2026-08-23, so `ROADMAP.md` itself could be cut back
down to a short, actually-workable list of what's still open (same cutover
`docs/roadmap-archive-2026-08-09.md` and `docs/roadmap-archive-2026-08-16.md`
already did once each). Nothing here is maintained going forward: don't
check items off in this file, don't add new ones. For ongoing work see
`ROADMAP.md`; for the continuing phase-by-phase historical record (including
everything shipped after this snapshot was taken) see `static/status.html`
(`/status`), which remains the actively-maintained backward-looking doc. For
anything shipped before 2026-08-16, see `docs/roadmap-archive-2026-08-16.md`
or `docs/roadmap-archive-2026-08-09.md` instead — this file only covers the
2026-08-16 → 2026-08-23 window.
