...
| #7 board path | Round 2 `:17`, `:78` = `docs/archive/lane-9-tooling-ci-process-governance/plans/2026-08-26-active-tracks-board.md`, which exists. `docs/next-action.md:346` = same path. `:208` uses the bare filename. No wrong path survives. |
