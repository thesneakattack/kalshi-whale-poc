...
- **CH3 resolved (2026-08-27) — classification: (ii) real but currently-negligible cost,
  ...
  rule, Phase P2.5 (`docs/archive/lane-1-kalshi-ingestion/plans/2026-08-25-realtime-data-plane-remediation.md`)
...
`docs/archive/lane-1-kalshi-ingestion/research/2026-08-27-application-wide-rest-vs-ws-inventory.md`. That
...
Task 17b (`docs/archive/lane-1-kalshi-ingestion/plans/2026-08-25-realtime-data-plane-remediation.md`) ran
