...
- `docs/archive/lane-1-kalshi-ingestion/research/2026-08-25-realtime-data-plane-baseline.md` §3 ("Exact
...
- `docs/kalshi/CHEATSHEET.md` — several entries reused directly, most importantly "Why
  ...
  scoping rules).
- `docs/archive/lane-1-kalshi-ingestion/research/2026-08-25-realtime-data-plane-known-findings.md` §H12 —
