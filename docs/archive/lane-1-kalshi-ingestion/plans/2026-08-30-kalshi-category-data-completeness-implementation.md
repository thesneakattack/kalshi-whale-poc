...
**Spec:** `docs/archive/lane-1-kalshi-ingestion/specs/2026-08-30-kalshi-category-data-completeness-design.md`
(finalized, GO verdict, two revision+review cycles). Evidence base:
`docs/archive/lane-1-kalshi-ingestion/research/2026-08-30-kalshi-category-data-shape-audit.md` (the census
