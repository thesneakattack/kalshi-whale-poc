...
def _connect():
    """Every existing `with _connect() as conn:` call site (five of them)
    keeps working unchanged - this yields the same conn as before, but now
    closes it on exit (2026-09-03, Task 3 of docs/superpowers/plans/
    ...
    the live fd census (2026-09-02) measured this file's handle count
    growing fastest of any store (5 -> 148+ in under an hour)."""
